...
struct perturbs
{
  ...
  short has_source_delta_dmb;   /**< do we need source for delta of dark matter scattering with baryons? */
  ...
  short has_source_theta_dmb;   /**< do we need source for theta of dark matter scattering with baryons? */
  ...
  int index_tp_delta_dmb;/**< index value for delta of dark matter scattering with baryons */
  ...
  int index_tp_theta_dmb;   /**< index value for theta of dark matter scattering with baryons */
...
struct perturb_vector
{
  ...
  int index_pt_delta_dmb;  /**< dmb density */
  int index_pt_theta_dmb;  /**< dmb velocity */
